...
netlogo.command('set intensity'" "+str(50))

netlogo.command('set hours-of-sleep'" "+str(10))
netlogo.command('set days-between-workouts'" "+str(4))
netlogo.command('set %-slow-twitch-fibers'" "+str(60))

netlogo.command('set inconsistency?'" "+str('true'))
netlogo.command('set inconsistencies-days-sleep'" "+str(40))
