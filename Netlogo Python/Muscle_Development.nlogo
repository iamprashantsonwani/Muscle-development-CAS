...
to inconsistencies
  if c = 0 [
  set tmphours-of-sleep   hours-of-sleep
  set tmpdays-between-workout days-between-workouts
  set c c + 1
  ]
  set j ceiling inconsistencies-days-sleep * 30
     ifelse i != j and i < j [
      set hours-of-sleep 1 + random 11
      set days-between-workouts 1 + random 29
      set i i + 1
     ]
    ; elsecommands
     [
      set hours-of-sleep tmphours-of-sleep  ;original value
      set days-between-workouts tmpdays-between-workout   ;original value
     ]
end
